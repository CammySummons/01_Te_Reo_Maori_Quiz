...
def option_selected(what_btn):
    ...
    if not btn_disabled:
        if num < 11:
            ...
            if eval(f"qst_{num-1}.answer") == eval(f"qst_{num-1}.btn{what_btn}_text") and num != 1:
                num_correct += 1
                output_box.config(bg="lime")
                output_box_txt.set("Correct!")
            elif eval(f"qst_{num-1}.answer") != eval(f"qst_{num-1}.btn{what_btn}_text") and num != 1:
            ...
            def up_btn():
                if num <= 10:
                    ...
                    qst_11 = Question(11, f"You finished the quiz and got {num_correct}/10 question"
...
def opt_btn_framework(text, btn_id):
    return Button(frame, bg="light green", command=lambda: option_selected(btn_id), textvariable=text, font=("Comic Sans MS", 14, "bold"))
...
# Questions
qst_0 = Question(0, "Welcome to the Te Reo Maori Quiz! "
                    "Press any of the buttons below to begin the quiz.",
                    "Click", "One", "Of", "Us", "answer")  # qst_0 is the welcome screen
qst_1 = Question(1, "What is 'red' in Maori ?", "Kahurangi", "Whero", "Rohi", "Rongo", "Whero")
qst_2 = Question(2, "What colour is 'kākāriki' ?", "Yellow", "Blue", "Green", "Orange", "Green")
qst_3 = Question(3, "What is 'orange' in Maori ?", "Karaka", "Kahurangi", "Kākāriki", "Ngako", "Karaka")
qst_4 = Question(4, "What colour is 'papura' ?", "Red", "Violet", "Yellow", "Purple", "Purple")
qst_5 = Question(5, "What is 'yellow' in Maori ?", "Whero whero", "Kōwhai", "Koura", "karekau", "Kōwhai")
qst_6 = Question(6, "What colour is 'Karekau' ?", "Silver", "Black", "Turquoise", "Crimson", "Turquoise")
qst_7 = Question(7, "What is 'lime' in Maori ?", "Pokarekare", "Ma", "Kotakota", "kākāriki", "Kotakota")
qst_8 = Question(8, "What colour is 'pango' ?", "Black", "Red", "White", "Yellow", "Black")
qst_9 = Question(9, "What is 'White' in Maori ?", "Kōwhai", "Ma", "Rohi", "Whero", "Ma")
qst_10 = Question(10, "What colour is 'parauri' ?", "Gold", "Purple", "Pink", "Brown", "Brown")
...
restart_btn = Button(frame, bg="pink", command=restart, text="Restart", font=("Comic Sans MS", 12, "bold"))
